		...
		<div class="footer-bottom-block ">
			<div class=" container">
				<div class="row">
					...
					<div class="col-sm-7">
						<div class="block-payment text-right"><img src="<?php echo get_template_directory_uri();?>/assets/image/demo/content/payment.png" alt="payment" title="payment" ></div>
					</div>
					<!--Back To Top-->
	...
	<ul class="items">
		<li class="item item-01 facebook"> <a href="php/facebook.php?account=envato" class="tab-icon"><span class="fa fa-facebook"></span></a>
			<div class="tab-content">
				...
				<div class="loading">
					<img src="<?php echo get_template_directory_uri();?>/assets/image/theme/lazy-loader.gif" class="ajaxloader" alt="loader">
				</div>
			</div>
		</li>
		...
		<li class="item item-03 youtube"> <a href="php/youtubevideo.php?account_video=PY2RLgTmiZY" class="tab-icon"><span class="fa fa-youtube"></span></a>
			<div class="tab-content">
				...
				<div class="loading"> <img src="<?php echo get_template_directory_uri();?>/assets/image/theme/lazy-loader.gif" class="ajaxloader" alt="loader"></div>
			</div>
		</li>
	</ul>
