const nextcodeGalleryIsLodash = () => {
    let nextcodeGalleryIsLodash = false;
    ...
    if ( 'undefined' != typeof( _ ) && 'function' == typeof( _.forEach ) ) {
        ...
        nextcodeGalleryIsLodash  = true;

        funcs.forEach( function ( func ) {
            // If just one of the functions do not exist, then not lodash
            nextcodeGalleryIsLodash = ( 'function' != typeof( _[ func ] ) ) ? false : nextcodeGalleryIsLodash;
        } );
    }

    if ( nextcodeGalleryIsLodash ) {
...
//jQuery( ".datepicker" ).datepicker();
    ...
    jQuery(document).ready(function () {
        ...
        var nextcodeGalleryLodashCounter = 0
        var nextcodeGalleryLodashInterval = setInterval(function(){
            if ( nextcodeGalleryIsLodash() ) {
                _.noConflict();
                clearInterval(nextcodeGalleryLodashInterval);
            } else if(nextcodeGalleryLodashCounter > 20) {
                clearInterval(nextcodeGalleryLodashInterval);
            }
            nextcodeGalleryLodashCounter++;
        }, 1000);
