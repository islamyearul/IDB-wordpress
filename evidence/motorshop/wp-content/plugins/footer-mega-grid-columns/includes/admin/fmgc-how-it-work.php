					...
					<div class="inside">
						<table class="form-table">
							<tbody>
								<tr>
									<td>
										<p><?php _e('Check design and best solutions for your website.', 'footer-mega-grid-columns'); ?></p> <br/>										
										<a class="button button-primary" href="<?php echo FMGC_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Footer&utm_campaign=Check-Designs-Solutions" target="_blank"><?php _e('Check Design & Solution', 'footer-mega-grid-columns'); ?></a>
									</td>
								</tr>
							</tbody>
						</table>
			...
			<div class="meta-box-sortables">
				<div class="postbox wpos-pro-box">
					...
					<div class="inside">
						...
						<a class="button button-primary wpos-button-full" href="<?php echo FMGC_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Footer-Mega-Grid&utm_campaign=How-It-Work" target="_blank"><?php _e('Go Premium', 'footer-mega-grid-columns'); ?></a>
