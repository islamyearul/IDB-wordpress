					...
					<table class="wpos-plugin-pricing-table">
						...
						<colgroup></colgroup>	
							...
							<tr>
								...
								<th>
									...
									<p><?php echo sprintf( __( 'Gain access to <strong>Footer Mega Grid Columns</strong> included in <br /><strong class="wpos-epb">Essential Plugin Bundle</strong>', 'footer-mega-grid-columns' ) ); ?></p>
						...
						<tfoot>
							<tr>
								<th></th>
								<td></td>
								<td><p><?php echo sprintf( __( 'Gain access to <strong>Footer Mega Grid Columns</strong> included in <br /><strong>Essential Plugin Bundle</strong>', 'footer-mega-grid-columns' ) ); ?></p>
								<a href="<?php echo FMGC_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Footer-Mega-Grid&utm_campaign=Upgrade-PRO" class="wpos-button" target="_blank"><?php _e( 'View Pricing Options', 'footer-mega-grid-columns' ); ?></a></td>
							</tr>
						</tfoot>
					</table>
			</div>	
				<!--Upgrad to Pro HTML -->
					<div id="postbox-container-1" class="postbox-container wpos-sidebar">
						<div class="wpos-epb-wrap">
							...
							<ul>
								<li><b>40+ Utility Plugins</b> including <span><?php echo FMGC_NAME; ?> premium </span> version.</li>
							...
							<a class="button-yellow" style="margin-bottom:0px;" href="<?php echo FMGC_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Logoshowcase&utm_campaign=EPB-Upgrade-PRO" target="_blank">Know More</a>
						</div>
